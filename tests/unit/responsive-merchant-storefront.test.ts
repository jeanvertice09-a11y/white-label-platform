...
describe("responsive merchant/storefront contracts", () => {
  ...
  test("admin mobile shell behaves as app navigation and has accessible drawer controls", () => {
  ...
  test("cart drawer locks background, supports Escape and exposes a focused close action", () => {
    ...
    expect(cart).toContain("<button autoFocus className=\"sf__close\"");
