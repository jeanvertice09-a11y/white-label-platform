...
function PublicProductPage(): React.JSX.Element {
  ...
  const behavior = getCatalogBehavior(data.settings); const cartEnabled = behavior.cartEnabled && behavior.showBuyButton && !behavior.catalogOnly;
